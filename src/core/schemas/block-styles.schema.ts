...
export const baseBlockStylesSchema = z.object({
  ...
  anchorName: optionalLength,
  anchorScope: optionalLength,
  positionAnchor: optionalLength,
  positionArea: optionalLength,
  positionTryFallbacks: optionalLength,
  positionTryOrder: optionalLength,
  positionVisibility: optionalLength,
  top: optionalLength,
