...
import HistoryPanel from '@/vue/components/history/HistoryPanel.vue'
import BlockLibraryPanel from '@/vue/components/library/BlockLibraryPanel.vue'
import ClassesPanel from '@/vue/components/library/ClassesPanel.vue'
import ComponentsPanel from '@/vue/components/library/ComponentsPanel.vue'
import PagesPanel from '@/vue/components/pages/PagesPanel.vue'
import PageTreePanel from '@/vue/components/pages/PageTreePanel.vue'
import SettingsPanel from '@/vue/components/settings/SettingsPanel.vue'
import VariablesPanel from '@/vue/components/variables/VariablesPanel.vue'
